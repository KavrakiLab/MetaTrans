...
def train_opts(parser):
    ...
    group.add_argument('-train_from', default='', type=str,
                       help="""If training from a checkpoint, starting with new parameters, then this is the
                       path to the pretrained model's state_dict.""")
    group.add_argument('-resume_training', default='', type=str,
                       help="""If training from a checkpoint - resuming from the last configuration.""")
