                    ...
                    if accum == self.grad_accum_count:
                        ...
                        if (step % valid_steps == 0):
                            with experiment.validate():
                                ...
                                experiment.log_metric("Validation perplexity:", valid_stats.ppl(), step=step)
                                experiment.log_metric("Validation accuracy:", valid_stats.accuracy(), step=step)
                                experiment.log_metric("Learning rate:", self.optim.learning_rate, step=step)
                        if self.gpu_rank == 0:
